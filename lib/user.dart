  ...
  Widget build(BuildContext context) {
    return  Scaffold(
       appBar: AppBar(
        ...
        leading: Icon(Icons.person_2_outlined,size: 25,color: Colors.white,),
      ),
                ...
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Icon(Icons.account_circle_outlined,size: 90,color: const Color.fromARGB(255, 89, 88, 88),),
                    ),
                  ),
                  SizedBox(
                    width: 5,
